...
const MobileSectionComponent = () => {
  return (
    <div className="section-container">
      ...
      <div className="section-image">
        <CardComponent
          coverImage={ControllerWall}
          characterImage={Controller}
        />
      </div>
      <div className="section-description">
        <Typography variant="h1">Cos&apos;è PCP?</Typography>
        <Typography className="section-content">
          PCP (Prototype Controller Profiler) è uno strumento potente e
          versatile che permette agli utenti di mappare in modo personalizzato i
          tasti di vari controller (da gioco, cloche di aviazione, joystick e
          altro) per adattarli a qualunque tipo di output. Grazie alla sua
          interfaccia web intuitiva, è possibile configurare ogni singolo tasto,
          adattando l&apos;input a scenari di utilizzo completamente diversi,
          dal controllo di dispositivi elettronici alla creazione di
          esperimentazioni interattive.
        </Typography>
      </div>
    </div>
