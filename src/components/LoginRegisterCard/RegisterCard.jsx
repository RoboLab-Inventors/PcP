...
const RegisterCard = ({ switchToLogin }) => {
  ...
  const submit = async (e) => {
    ...
    const birthDate = document.getElementById("gender");
    const firstName = document.getElementById("firstName");
    const lastName = document.getElementById("lastName");

    await fetch("http://172.20.10.12:3000/registerUsers", {
      method: "POST",
      headers: {
    ...
    <div className="login-register-body">
      <div className="login-register-card">
        ...
        <form onSubmit={submit}>
          ...
          <div className="container-container">
            <div className="input-container">
              <input type="text" id="username" required placeholder=" " className="input-insert"/>
          ...
          <div className="container-container">
            <div className="input-container">
              <input type="text" id="firstName" required placeholder=" " className="input-insert"/>
            ...
            <div className="container-container">
              <div className="input-container">
                <input type="text" id="lastName" required placeholder=" " className="input-insert"/>
                <label htmlFor="lastName" className="input-label">Cognome</label>
                <svg className="error-icon hover-target" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="9"></circle>
                  <path d="M12 8v4"></path>
                  <path d="M12 16h.01"></path>
          ...
          <div className="extra-fields">
            <div className="date-container">
              ...
              <input type="date" id="birthDate" required className="date-insert"/>
            </div>
          ...
          <p>Hai già un account? <a href="#" onClick={switchToLogin} className = "linkTo">Accedi ora</a></p>
          <div className="button-group">
            <CustomButton label="Compila il Questionario" onClick={() => window.open('https://forms.gle/uhjwk41UX9vZ4H287', '_blank')} />
